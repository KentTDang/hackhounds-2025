          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <ThemedText type="defaultSemiBold" style={styles.popupdesc}>
                  Actual info
                </ThemedText>
      ...
      <ThemedView style={styles.moneycontainer}>
        <ThemedView style={styles.tasktext}>
          ...
          <ThemedView style={styles.userprofile}>
            ...
            <ThemedText type="default" style={styles.taskdesc}>
              Nice to see you!
            </ThemedText>
          </ThemedView>
        </ThemedView>
        <ThemedView style={styles.tasktime}></ThemedView>
      </ThemedView>
          ...
          >
            <ThemedView style={styles.lefthandstep}>
              <ThemedText style={styles.alertdesc}>
                ...
                <ThemedText type="subtitle" style={styles.alertdesc}>
                  Whatever:{"\n"}
                </ThemedText>
                <ThemedText type="default">
                  Actual info{"\n"}
